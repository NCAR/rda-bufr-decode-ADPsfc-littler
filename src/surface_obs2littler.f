!================================================================================
      program makeobs
!================================================================================
!     Read in prepared surface observations and write output in little_r 
!     format

!     Usage:
!         surface_obs2littler.x <input obs file> <yyyymmddhh>
!     Examples:
!         surface_obs2littler.x adpsfc2024030100.obs 2024030100
!         surface_obs2littler.x sfcshp2024030100.obs 2024030100
...
222   fout1 = 'SURFACE_OBS:'//time_tag
...
19    continue
      ...
      print*, 'error writing surface data'
      stop 19
